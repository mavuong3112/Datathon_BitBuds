...
OUT_EMB  = f"{CACHE_DIR}/test_user_emb.npy"
OUT_META = f"{CACHE_DIR}/test_user_meta.pkl"
...
EMB_PATH = f"{CACHE_DIR}/als_model/item_factors_bpr.npy"
item_emb_mmap = np.load(EMB_PATH, mmap_mode='r')
...
print(f"{elapsed()} Streaming user_item_pos.parquet …", flush=True)
pf = pq.ParquetFile(f"{CACHE_DIR}/user_item_pos.parquet")
batch_count = 0
