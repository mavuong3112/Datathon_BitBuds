...
OUT_PATH      = f"{CACHE_DIR}/itemcf_candidates.parquet"
EMB_USER_PATH = f"{CACHE_DIR}/test_user_emb.npy"
META_PATH     = f"{CACHE_DIR}/test_user_meta.pkl"
EMB_ITEM_PATH = f"{CACHE_DIR}/als_model/item_factors_bpr.npy"
